...
This repository has single purposes:
- Being a general manual about opensourcing
...
- **Email**: # TODO(charlie4fun): add contact email
- **Issue tracker**: #TODO(charlie4fun): add issue tracker link
